...
information are essential to confirm and verify results. Some approaches
you might consider include the following:
...
view of the entire municipality. Other planning factors should be
incorporated in subsequent suitability analyses to determine whether
specific areas are well suited or poorly suited for development or
implementation of a specific housing growth policy. The developable land
inventory is a starting point that feeds into that later, more detailed
planning process that culminates in a Housing Growth Plan.
